...
typedef struct {
    rt_uint32_t  regs[MIPS_REG_NR];
    rt_uint32_t  CP0Status;
    rt_uint32_t  CP0DataHI;
    rt_uint32_t  CP0DataLO;
    rt_uint32_t  CP0BadVAddr;
    rt_uint32_t  CP0Cause;
    rt_uint32_t  CP0EPC;
} mips_reg_ctx;
...
typedef struct
{
    rt_uint32_t  args[MIPS_ARG_REG_NR];
} mips_arg_ctx;
